...
export default function InputPassword():JSX.Element {
    ...
    return (
        <form className="container">
            ...
            <input type={type} name="password" placeholder="password" onChange={changing} value={pass}/>
            <button onClick={mostrarPass} >Mostrar Pass</button>
            <button type="submit" onClick={submiting} disabled={ok}>Enviar</button>
            <br/>
            <span>*Debe contener al menos una Mayuscula, una Minuscula, y un numero</span>
